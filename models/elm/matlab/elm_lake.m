...
% snowdp = nc_varget('e3sm_case.elm2.r.2000-12-31-00000.nc','SNOWDP');

% Set fname to the ELM restart file being investigated.
fname   = 'e3sm_case.elm2.r.2000-12-31-00000.nc';
