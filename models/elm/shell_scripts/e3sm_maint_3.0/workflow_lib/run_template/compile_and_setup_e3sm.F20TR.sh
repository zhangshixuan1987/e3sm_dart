...
readonly GET_REFCASE=TRUE #FALSE
...
readonly sst_data="${my_amip_sst_data:?my_amip_sst_data is not set}"
readonly sst_grid="${my_amip_sst_grid:?my_amip_sst_grid is not set}"
